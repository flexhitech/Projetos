...
var FormCheck = new Class({
	options : {
		...
		alerts : {
			...
			alpha        : "Este campo aceita somente letras.",
			alphanum     : "Este campo só aceita caracteres alfanuméricos.",
			nodigit      : "Campo não aceita números.",
			digit        : "Entrar com um número inteiro válido.",
			digitmin     : "The number must be at least %0",
			digitltd     : "The value must be between %0 and %1",
			number       : "Please enter a valid number.",
			email        : "Entre com um e-mail válido: <br /><span>E.g. yourname@domain.com</span>",
